...
$sql = ' select student.fname as fname,student.lname as lname, feedback.ename as ename, feedback.feedback as fb from feedback join student on feedback.sid=student.sid ';
...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a http://localhost/minipro/proviewfb.php"><span class="glyphicon glyphicon-user"></span> FEEDBACK</a></li>
	...
	<table class="data-table">
		<caption class="title">LIST Of Feedback</caption>
		<thead>
			<tr>
				<th>FIRST NAME</th>
				<th>LAST NAME</th>
		...
		while ($row = mysqli_fetch_array($query))
		{
			...
			echo '<tr><td>'.$row['fname'].'</td><td>'.$row['lname'].'</td><td>'.$row['ename'].'</td><td>'.$row['fb']. '</td></tr>';;
